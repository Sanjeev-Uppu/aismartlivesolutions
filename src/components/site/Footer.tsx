...
export function Footer() {
  return (
    <footer className="border-t border-border bg-surface/40 mt-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-14 grid gap-12 md:grid-cols-4">
        {/* Company Info */}
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm text-muted-foreground leading-relaxed">
            AI Smart Live Solutions Pvt Ltd builds next-generation AI products
            that help enterprises automate, create, and learn at scale.
          </p>
